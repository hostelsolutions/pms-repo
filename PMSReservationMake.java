...
//	private DBArrivalReservations arrivalDB;
...
//
//		this.arrivalTable = table;
//		this.arrivalDB = (DBArrivalReservations) dbConn;
//		this.arrivalColumns = columns;
...
//		
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() == confirm) {
			...
			//
			//Main.login.mainScrn.refreshTable(arrivalTable, arrivalColumns, arrivalRows, arrivalDB);
